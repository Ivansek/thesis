...
\subsection{Proporcionalna izbira}
Slabost izbire z ruletnim kolesom je, da ne deluje za minimizacijske probleme in moramo zato minimizacijski problem prevesti na maksimizacijski. \textcolor{red}{V na\v sem primeru, kjer manj\v sa vrednost pomeni bolj\v so kvaliteto, smo to naredili tako, da predno kli\v cemo metodo ruletnega kolesa, kvalitete pomno\v zimo s faktorjem $-1$. Na ta na\v cin prej manj\v se vrednosti dobijo ve\v cjo te\v zo, prej ve\v cje vrednosti pa manj\v so te\v zo.}

\textcolor{red}{Po izvajanju metode ruletnega kolesa kvalitete ponovno pomno\v zimo s faktorjem $-1$, da dobimo nazaj prvotne vrednosti. Algoritem \ref{alg:ruletno kolo} prikazuje psevdo kodo za izbiro osebkov z metodo ruletnega kolesa.}

Po pretvorbi kvalitet moramo pred izvajanjem metode ruletnega kolesa kvalitete \v se normalizirati in izra\v cunati kumulativne vrednosti normaliziranih kvalitet. Kvalitete normaliziramo na interval med $[0, 1]$ tako, da za vsak osebek izra\v cunamo verjetnost proporcionalno glede na kumulativno oceno kvalitete vseh osebkov (ena\v cba  \ref{eq:proporcionalna izbira}).

Kumulativne vrednosti normaliziranih kvalitet izra\v cunamo tako, da pri\v stejemo k lastni kvaliteti kvalitete vseh prej\v snih osebkov, kar prikazuje algoritem \ref{alg:akumulirana kvaliteta}. 
...
Elitizem in mutacijo izvedemo na enak na\v cin kot pri proporcionalni izbiri, saj 25 osebkov prenesemo direktno v novo populacijo, mutacijo pa izvedemo nad petimi naklju\v cno izbranimi potomci in jih shranimo v novo populacijo.
...
\bibitem{sarmady} (avgust 2012) Siamak Sarmady, \textit{An Investigation on Genetic Algorithm Parameters}. Dostopno na:\\ 
http://sarmady.com/siamak/papers/genetic-algorithm.pdf
\bibitem{wikipedia genetski algoritmi} (avgust 2012) Genetic algorithm from Wikipedia, the free encyclopedia. Dostopno na: http://en.wikipedia.org/wiki/Genetic\_algorithm
\bibitem{aijunkie} (julij 2012) Genetic Algorithms in Plain English. Dostopno na:\\
http://www.ai-junkie.com/ga/intro/gat1.html
\bibitem{github-stohasticno} (julij 2012) Izvorna koda stohasti\v cnega univerzalnega vzor\v cenja v Javi.\\ Dostopno na: https://github.com/dwdyer/watchmaker/blob/master/framework/src/
java/main/org/uncommons/watchmaker/framework/selection/StochasticUniversalSampling.java
\newpage
\bibitem{wikipedia-html} (avgust 2012) HTML from Wikipedia, the free encyclopedia. \\
Dostopno na: http://en.wikipedia.org/wiki/Html
\bibitem{html5rocks} (avgust 2012) HTML5 Rocks. Dostopno na:\\
http://www.html5rocks.com/
\bibitem{wikipedia-github} (avgust 2012) GitHub from Wikipedia, the free encyclopedia.\\
Dostopno na: http://en.wikipedia.org/wiki/Github
\bibitem{slika ruletno kolo}(avgust 2012) Roulette wheel selection. Dostopno na:\\
http://www.edc.ncl.ac.uk/highlight/rhjanuary2007g02.php/
\bibitem{izvorna koda}(avgust 2012) Izvorna koda aplikacije. Dostopno na:\\
https://github.com/Ivansek/thesis
\bibitem{uc3m}(avgust 2012) Erick Cantu-Paz, \textit{A Survey of Parallel Genetic Algorithms}. Dostopno na: http://tracer.uc3m.es/tws/cEA/documents/cant98.pdf
\end{thebibliography}
\end{document}
